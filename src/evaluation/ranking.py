...
def evaluate(args, index=None):
    qrels, queries, topK_docs, topK_pids = (
        args.qrels,
        args.queries,
        args.topK_docs,
        args.topK_pids,
    ...
    metrics = Metrics(
        mrr_depths={10}, recall_depths={50, 200, 1000}, total_queries=None
    )
    ...
    output_path = Path(args.output_dir) / f"run_{checkpoint_name}_{run_name}.tsv"
